...
<div style="float: right;">
  <ul>
  <? if(($_SERVER['REQUEST_URI'] != '/') && ($_SERVER['REQUEST_URI'] != '/index.php') && ($_SERVER['REQUEST_URI'] != '/group.php') && ($_SERVER['REQUEST_URI'] != '/admin.php')&& ($_SERVER['REQUEST_URI'] != '/user_settings.php')){
